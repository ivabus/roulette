# Рулетка / Roulette [![Test build](https://github.com/ivabus/roulette/actions/workflows/build.yml/badge.svg)](https://github.com/ivabus/roulette/actions/workflows/build.yml)
